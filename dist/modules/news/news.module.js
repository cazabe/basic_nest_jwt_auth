...
exports.NewsModule = NewsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [news_service_1.NewsService, providers_1.SlugProvider],
        controllers: [news_controller_1.NewsController, backoffice_controller_1.BackofficeController],
    })
], NewsModule);
