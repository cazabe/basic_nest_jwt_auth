...
let RolesGuard = exports.RolesGuard = class RolesGuard {
    ...
    canActivate(context) {
        ...
        const all = this.reflector.get(constants_1.ROLES_ALL, context.getHandler());
        ...
        if (roles === undefined) {
            if (!admin) {
                ...
                throw new common_1.ForbiddenException('No tienes permisos para esta operacion');
            }
        }
        if (roleUser === constants_1.ROLES.ADMIN) {
            return true;
        }
